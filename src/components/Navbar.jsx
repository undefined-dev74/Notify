      ...
      <div>
        <nav className=" model_nav navbar">
          <Col
            xs={6}
            lg={3}
            className="d-flex justify-content-center justify-content-sm-center justify-content-md-around order-sm-1 order-xl-1"
          >
          ...
          <Col
            xs={12}
            lg={6}
            className="d-flex justify-content-center order-sm-12 order-xl-2 mt-sm-2"
          >
          ...
          <Col
            xs={6}
            lg={3}
            className="d-flex justify-content-end justify-content-md-around order-sm-2 order-xl-3"
          >
